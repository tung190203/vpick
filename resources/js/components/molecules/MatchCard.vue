<template>
  ...
  defineProps({
    matchTitle: {
      type: String,
      default: 'Trận đấu số 1'
    },
    matchTime: {
      type: String,
      default: '17:00 - 20/9/25'
    },
    courtName: {
      type: String,
      default: 'Sân 1'
    ...
    team1: {
      type: Array,
      default: () => [
        { id: 1, name: 'ABC', avatar: 'https://i.pravatar.cc/150?img=1', rating: 4.5, status: 'approved' },
        { id: 2, name: 'CDE', avatar: 'https://i.pravatar.cc/150?img=2', rating: 4.5, status: 'pending' }
      ]
    },
    team2: {
      type: Array,
      default: () => [
        { id: 3, name: 'ABC', avatar: 'https://i.pravatar.cc/150?img=3', rating: 4.5, status: 'rejected' }
      ]
    },
    sets: {
      type: Array,
