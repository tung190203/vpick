                        ...
                        <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                            ...
                            <div class="md:col-span-4">
                                <h3 class="text-sm font-semibold text-gray-700 mb-3">
                                    Môn thể thao của tôi • {{ selectedSportsDisplay.length }}
                                </h3>
                                <div class="grid grid-cols-2 gap-3 h-72 overflow-y-scroll">
                                    ...
                                    <div v-if="selectedSportsDisplay.length === 0" class="col-span-2 text-center py-8 text-gray-400 text-sm">
...
// Khởi tạo từ mySports khi mở modal
watch(() => props.isOpen, (newVal) => {
    if (newVal) {
        selectedSportsWithLevel.value = props.mySports.map(s => {
            const personalScore = s.scores && typeof s.scores === 'object'
                ? s.scores.personal_score ?? 1
                : 1;
            return {
