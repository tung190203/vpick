...
class ClubActivityResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'cancellation_deadline' => $this->cancellation_deadline?->format('c'),
            ...
            'fund_collection_id' => $this->fundCollection?->id !== null ? (int) $this->fundCollection->id : null,
            ...
            'fund_collection' => $this->whenLoaded('fundCollection', fn() => new ClubFundCollectionResource($this->fundCollection)),
