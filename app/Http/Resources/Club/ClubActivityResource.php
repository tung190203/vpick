...
class ClubActivityResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'competition_location' => $this->whenLoaded('competitionLocation', function () {
                return [
                    'id' => $this->competitionLocation->id,
                    'name' => $this->competitionLocation->name,
                    'latitude' => $this->competitionLocation->latitude,
                    'longitude' => $this->competitionLocation->longitude,
                    'image' => $this->competitionLocation->image,
                    'address' => $this->competitionLocation->address,
                    'phone' => $this->competitionLocation->phone,
                    'opening_time' => $this->competitionLocation->opening_time,
                    'closing_time' => $this->competitionLocation->closing_time,
                    'note_booking' => $this->competitionLocation->note_booking,
                    'website' => $this->competitionLocation->website,
                ];
            }),
